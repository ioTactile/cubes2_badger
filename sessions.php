  ...
  <div class="flex flex-col w-full">
    <div class="flex justify-between bg-neutral-200">
      <div class="flex items-center justify-center w-[65%]">
        <h2 class="text-xl text-bold">Liste des cours</h2>
      </div>
      <button class="w-[35%] bg-emerald-700 text-white py-3 px-6 cursor-pointer "><a class="text-white hover:text-sky-400" href="./addsessions.php">Ajouter un cours</a></button>
    </div>
          ...
          <div class="overflow-hidden">
            <table class="min-w-full text-center">
              <thead class="border-b bg-neutral-700">
                <th scope="col" class="text-sm font-medium text-white px-6 py-4">Titre</th>
              ...
              <tbody>
                ...
                ?>
                  <tr class="bg-white border-b">
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"><?= $session["title"] ?></td>
